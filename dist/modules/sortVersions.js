...
function getTypeList(versions) {
    ...
    if (!versions)
        return 'empty';
    if ((versions === null || versions === void 0 ? void 0 : versions.length) === undefined)
        return 'object';
    if (!versions.length)
        return 'empty';
    if (typeof versions[0] === 'string')
        return 'string';
    if ((_a = versions[0]) === null || _a === void 0 ? void 0 : _a.version)
        return 'array';
}
...
function formatNewList(versions, typeList = 'empty', sortedTags) {
    ...
    if (typeList == 'string')
        return sortedTags;
    if (typeList == 'object')
        return sortedTags.map(tag => versions[tag]);
    if (typeList == 'array') {
...
//# sourceMappingURL=sortVersions.js.map