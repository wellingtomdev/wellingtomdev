...
const index_js_2 = __importDefault(require("../client/index.js"));
...
(0, vitest_1.describe)('socketServer', () => {
    ...
    (0, vitest_1.describe)('createServer', () => {
        (0, vitest_1.test)('Métodos', () => {
            (0, vitest_1.expect)(index_js_1.default.getSocketServer).toBeDefined();
            (0, vitest_1.expect)(index_js_1.default.createServer).toBeDefined();
        });
        (0, vitest_1.test)('createServer', () => __awaiter(void 0, void 0, void 0, function* () {
            const server = yield index_js_1.default.createServer({ port: 3001 });
    ...
    (0, vitest_1.describe)('createClient', () => {
        (0, vitest_1.test)('Conecta a um socket', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const client = index_js_2.default.createClient({ url: `http://localhost:3001` });
    ...
    (0, vitest_1.describe)('request', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, vitest_1.test)('Sem metodos', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const methods = {};
            const client = index_js_2.default.createClient({ url: `http://localhost:3001`, methods });
            yield client.waitConnection();
    ...
    (0, vitest_1.describe)('Cenários', () => {
        (0, vitest_1.test)('3 clientes', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const client1 = index_js_2.default.createClient({ url: serverUrl, methods, name: 'client1' });
            const client2 = index_js_2.default.createClient({ url: serverUrl, methods, name: 'client2' });
            const client3 = index_js_2.default.createClient({ url: serverUrl, methods, name: 'client3' });
        ...
        (0, vitest_1.test)('Nomes iguais', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const serverUrl = `http://localhost:3001`;
            const client1 = index_js_2.default.createClient({ url: serverUrl, name: 'client', onDuplicated });
            const client2 = index_js_2.default.createClient({ url: serverUrl, name: 'client', onDuplicated });
            const client3 = index_js_2.default.createClient({ url: serverUrl, name: 'client', onDuplicated });
            const clients = [client1, client2, client3];
            yield Promise.all(clients.map(client => client.waitConnection()));
        ...
        (0, vitest_1.test)('Desconexão', () => __awaiter(void 0, void 0, void 0, function* () {
            const { server } = yield createServerForTests('message');
            const serverUrl = `http://localhost:3001`;
            const client1 = index_js_2.default.createClient({ url: serverUrl });
            const client2 = index_js_2.default.createClient({ url: serverUrl });
            const client3 = index_js_2.default.createClient({ url: serverUrl });
            const clients = [client1, client2, client3];
            yield Promise.all(clients.map(client => client.waitConnection()));
